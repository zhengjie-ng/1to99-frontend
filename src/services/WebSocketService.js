...
class WebSocketService {
  constructor() {
    ...
    const wsMode = import.meta.env.VITE_WS_MODE || "local";
    const localUrl = import.meta.env.VITE_WS_URL_LOCAL || "http://localhost:8080";
    const ngrokUrl = import.meta.env.VITE_WS_URL_NGROK;
    const productionUrl = import.meta.env.VITE_WS_URL_PRODUCTION;

    console.log("Environment variables:", {
      wsMode: import.meta.env.VITE_WS_MODE,
      localUrl: import.meta.env.VITE_WS_URL_LOCAL,
      ngrokUrl: import.meta.env.VITE_WS_URL_NGROK,
      productionUrl: import.meta.env.VITE_WS_URL_PRODUCTION,
    });
